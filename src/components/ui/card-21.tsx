        ...
        >
          ...
          <div className="relative flex flex-col justify-end h-full p-4 sm:p-6 text-white">
            <h3 className="text-xl sm:text-3xl font-bold tracking-tight">
              {location} <span className="text-lg sm:text-2xl ml-1">{flag}</span>
            </h3>
            <p className="text-xs sm:text-sm text-white/80 mt-1 font-medium">{stats}</p>

            <div className="mt-4 sm:mt-8 flex items-center justify-between bg-[hsl(var(--theme-color)/0.2)] backdrop-blur-md border border-[hsl(var(--theme-color)/0.3)] 
              ...
              <span className="text-xs sm:text-sm font-semibold tracking-wide">Explore Now</span>
              <ArrowRight className="h-3 sm:h-4 w-3 sm:w-4 transform transition-transform duration-300 group-hover:translate-x-1" />
            </div>
          </div>
        </a>
      </div>
